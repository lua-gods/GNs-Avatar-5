---@diagnostic disable: redefined-local, assign-type-mismatch
--[[______   __
...
function ModelPart:play(animationName)
	...
	applyNested(self,function (self, id)
		local sourceModel=modelOriginals[self]
		if sourceModel then
...
---@param speed any
---@return ModelPart
function ModelPart:speed(speed)
...
---@return ModelPart
function ModelPart:blend(amplifier)
	applyNested(self,function (self)
		local state=animationStates[self]
		if state then
